...
evaluation.evalrank("runs/flickr_VSRN/model_best.pth.tar", data_path='data', split="dev", fold5=False)
evaluation.evalrank("runs/flickr_VSRN/model_best.pth.tar", data_path='/SSD/Datasets/Coco-Text/ST_CMR_testdataset/New_Split/Flickr_Format/', split="test", fold5=False)

# evaluation.evalrank("runs/flickr_VSRN/model_best.pth.tar", data_path='data', split="train", fold5=False)
